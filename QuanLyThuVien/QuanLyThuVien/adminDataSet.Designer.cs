...
namespace QuanLyThuVien.adminDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[login] WHERE (([idLogin] = @Original_idLogin) AND ([username] " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[login] ([username], [password]) VALUES (@username, @password);" +
                "\r\nSELECT idLogin, username, password FROM login WHERE (idLogin = SCOPE_IDENTITY(" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[login] SET [username] = @username, [password] = @password WHERE (([idLogin] = @Original_idLogin) AND ([username] = @Original_username) AND ([password] = @Original_password));
SELECT idLogin, username, password FROM login WHERE (idLogin = @idLogin)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyThuVien.Properties.Settings.Default.adminConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idLogin, username, password FROM dbo.login";
        ...
        public virtual int Fill(adminDataSet.loginDataTable dataTable) {
        ...
        public virtual adminDataSet.loginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            adminDataSet.loginDataTable dataTable = new adminDataSet.loginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(adminDataSet.loginDataTable dataTable) {
